...
permalink: /team/filippo-ruffini/
description: Full profile and selected publications of Filippo Ruffini.
---

{% assign member = site.data.team | where: "slug", "filippo-ruffini" | first %}
