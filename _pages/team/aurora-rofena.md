...
layout: page
title: Aurora Rofena
permalink: /team/aurora-rofena/
description: Full profile and selected publications of Aurora Rofena.
---

{% assign member = site.data.team | where: "slug", "aurora-rofena" | first %}
