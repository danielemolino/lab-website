...
layout: page
title: Irene Iele
permalink: /team/irene-iele/
description: Full profile and recent publications of Irene Iele.
---

{% assign member = site.data.team | where: "slug", "irene-iele" | first %}
  ...
  <div class="member-profile-section">
    ...
    {% else %}
      <p class="member-profile-footnote">
        ...
        <a href="{{ '/publications/' | relative_url }}?search=Irene%20Iele">{{ '/publications/' | relative_url }}?search=Irene Iele</a>
      </p>
    {% endif %}
  </div>
</section>
